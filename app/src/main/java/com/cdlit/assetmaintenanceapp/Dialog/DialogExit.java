...
import com.cdlit.assetmaintenanceapp.Ui.ActivityLogin;
...
public class DialogExit extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
      ...
      //  customTitle.setAllCaps(true);
        ...
        alertDialogBuilder.setPositiveButton(getResources().getString(R.string.bt_positive_exit), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {

                if (getActivity() instanceof ActivityNavigationDrawerAdmin) {

                    ((ActivityNavigationDrawerAdmin) getActivity()).exitPositiveClick();

                } else if (getActivity() instanceof ActivityLogin) {

                    ((ActivityLogin) getActivity()).exitPositiveClick();
