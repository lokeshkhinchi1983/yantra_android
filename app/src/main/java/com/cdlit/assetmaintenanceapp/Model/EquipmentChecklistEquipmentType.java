...
public class EquipmentChecklistEquipmentType {
    ...
    private EquipmentChecklistCategory category;
    ...
    public void setCategory(EquipmentChecklistCategory category) {
        this.category = category;
    }

    public EquipmentChecklistCategory getCategory() {
